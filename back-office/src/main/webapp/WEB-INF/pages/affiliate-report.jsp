...
<s:layout-render name="../layout/content-layout.jsp" pageID="affiliate-report" pageTitle="Affiliate Report">
            ...
            <script type="text/html">
                <table>
                    ...
                    <tbody>
                        ...
                        {/for}
                        {if rows.length == 0} <tr><td colspan="27" class="nofound" style="text-align: center">Sorry, no result found</td></tr> {/if}
                    </tbody>
                </table>
            </script>
        </div>
