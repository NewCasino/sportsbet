...
<%@ page import="com.pr7.keno.constant.KenoGameType" %>
<%@ page import="com.pr7.keno.constant.KenoStatus" %>
<%@ page import="com.pr7.modelsb.constant.PurposeReportEnum" %>
<s:layout-render name="../../layout/content-layout.jsp" pageID="keno-transactions" pageTitle="Keno Transactions">
    ...
    <s:layout-component name="content">        
        ...
        <% pageContext.setAttribute("kenoGameType", KenoGameType.values()); %>
        ...
        <div id="searchbox">
            <form action="#">
                ...
                <div class="field">
                    ...
                    <input type="text" name="gameCode" id="game-code" class="txt" />
                </div>
                ...
                <div class="field">
                    ...
                    <select name="betType" id="betType">
                        ...
                        <c:forEach var="gameType" items="${kenoGameType}">
