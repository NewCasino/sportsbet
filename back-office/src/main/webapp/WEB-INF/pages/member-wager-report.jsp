...
<s:layout-render name="../layout/content-layout.jsp" pageID="member-wager-report" pageTitle="Member Wager Report">
        ...
        <div id="searchbox">
            <form action="#">
                ...
                <div class="field">
                 ...
                 <div class="field">
                    <label><input type="checkbox" name="emptyDateMatch" id="emptyDateMatch" />  Empty Date Match</label>
                    ...
                    <tbody>
                        ...
                        {for row in rows}                            
                            <tr class="@{parseInt(row_index) % 2 == 0 ? 'odd' : 'even'}"
                                ...
                                <td>@{row.takingPos ? row.takingPos*100 + '%' : '-'}</td>
                                ...
                                <td>@{row.contraWager ? row.contraWager : '-'}</td>
                            </tr>  
